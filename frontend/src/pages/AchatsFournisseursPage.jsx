...
function AchatsFournisseursPage() {
  ...
  return (
    <div className="achats-container" style={{ padding: '20px', maxWidth: '1600px', margin: '0 auto' }}>
      ...
      {/* ... Le reste du code reste identique jusqu'à la modal commande ... */}
      {/* Je vais maintenant concentrer sur la partie modal commande avec les lignes */}
      
      {/* MODAL COMMANDE AVEC LIGNES */}
      {showCommandeModal && (
        <div style={{
          position: 'fixed',
          top: 0,
              ...
              <div style={{
                ...
                {commandeLignes.length === 0 ? (
                  <div style={{
                    ...
                    Aucune ligne de commande ajoutée. Veuillez ajouter au moins une ligne.
                  </div>
                ) : (
