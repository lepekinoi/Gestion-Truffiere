...
function AchatsFournisseursPage() {
  ...
  const handleCommandeSubmit = async (e) => {
    ...
    try {
      if (editingCommande) {
        await axios.put(`${API_URL}/commandes-achats/${editingCommande.id}`, commandeFormData);
        showMessage('Commande modifiée avec succès !', 'success');
      } else {
        await axios.post(`${API_URL}/commandes-achats`, commandeFormData);
        ...
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={handleCommandeSubmit}>
              {/* Fournisseur */}
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600 }}>Fournisseur *</label>
                <select
                  name="fournisseur_id"
              ...
              {/* Numéro commande */}
              <div style={{ marginBottom: '20px' }}>
                <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600 }}>N° Commande</label>
                <input
                  type="text"
                  name="numero_commande"
                  value={commandeFormData.numero_commande}
                  onChange={handleCommandeInputChange}
                  style={{
                    width: '100%',
                    padding: '10px',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '20px' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600 }}>Date commande *</label>
                  <input
                    type="date"
                    name="date_commande"
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600 }}>Livraison prévue</label>
                  <input
                    type="date"
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '20px' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600 }}>Montant total (€)</label>
                  <input
                    type="number"
                    name="montant_total"
                    value={commandeFormData.montant_total}
                    onChange={handleCommandeInputChange}
                    min="0"
                    step="0.01"
                    style={{
