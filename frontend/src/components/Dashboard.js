...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (availableYears.length > 0) {
      ...
      console.log('📊 DEBUG last3Years:', last3Years);
  ...
  const loadDashboardData = async () => {
    try {
      ...
      console.log('🐛 DEBUG recoltesMensuellesRes.data:', recoltesMensuellesRes.data);
      ...
      console.log('🐛 DEBUG years extraites:', years);
  ...
  const loadAllYearsData = async () => {
    try {
      ...
      console.log('🐛 DEBUG productionParMoisMultiAnnee:', allData);
    } catch (err) {
